      ...
      <Card maxW="sm">
        <CardBody>
          ...
          <Stack mt="6" spacing="3" textAlign="left">
            ...
            <HStack>
              <Heading size="sm">Brand -</Heading> <Text> {brand}</Text>
            </HStack>
            <StarRating numReviews={reviews} rating={ratings} />

            <Box>
              <Text as="span" mr="2rem" fontSize="1.3rem" fontWeight="bold">
                ₹ {discountprice}
              </Text>
              <Text as="span" textDecoration="line-through">
                ₹ {price}{" "}
              </Text>
              <Text as="span" color="rgb(39 160 65)">
                {" "}
                ({Math.ceil((discountprice * 100) / price)}% OFF)
              </Text>
            </Box>
          </Stack>
        </CardBody>
