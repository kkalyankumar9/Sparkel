...
const AdminEditProduct = () => {
  ...
  useEffect(() => {
    getSingleEditProduct(id).then((req) => setNewProduct({ ...req.data }));
  }, []);
  ...
  const formHandler = (e: FormEvent) => {
    ...
    const tempValue = {
      ...newProduct,
      discountPercentage: `(${Math.ceil((discountprice * 100) / price)}% OFF)`,
    };
    setNewProduct(tempValue);
    editAdminProduct(id, tempValue).then((req) => {
      toast({
        position: "top",
          ...
          <Stack spacing="2rem">
            ...
            <FormControl>
              <Input
                ...
                required
                border="2px solid #282828"
                placeholder="Enter the product price after discount:-"
            ...
            <RadioGroup
              value={isNew === true ? "true" : "false"}
              onChange={(e) =>
                setNewProduct({
                  ...newProduct,
                  isNew: e === "true" ? true : false,
                })
              }
            >
              <HStack spacing="24px">
            ...
            <RadioGroup
              value={assured === true ? "true" : "false"}
              onChange={(e) =>
                setNewProduct({
                  ...newProduct,
                  assured: e === "true" ? true : false,
                })
              }
            >
              <HStack spacing="24px">
